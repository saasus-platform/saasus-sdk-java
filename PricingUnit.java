                    ...
                    if (jsonObject.get("type") == null) {
                        ...
                        switch (jsonObject.get("type").getAsString()) {
                            ...
                            case "usage":
                                ...
                                return newPricingUnit;
                            default:
                            log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for PricingUnit. Possible values: fixed tiered tiered_usage usage", jsonObject.get("type").getAsString()));
                        }
                    }
