 ...
 * Customers
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-23T12:17:26.548972851Z[Etc/UTC]")
public class Customers {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customers, customers.customers);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Customers
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Customers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Customers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Customers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
