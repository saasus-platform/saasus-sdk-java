...
public class EventMessage {
  ...
  **/
   ...
   * @return the EventMessage instance itself
   */
  public EventMessage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventType, eventMessage.eventType) &&
        ...
        Objects.equals(this.additionalProperties, eventMessage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventType, eventDetailType, message, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EventMessage>() {
           ...
           public EventMessage read(JsonReader in) throws IOException {
             ...
             EventMessage instance = thisAdapter.fromJsonTree(jsonObj);
