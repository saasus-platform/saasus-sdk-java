...
public class Feedbacks {
  ...
  **/
   ...
   * @return the Feedbacks instance itself
   */
  public Feedbacks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.feedbacks, feedbacks.feedbacks)&&
        Objects.equals(this.additionalProperties, feedbacks.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feedbacks, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Feedbacks>() {
           ...
           public Feedbacks read(JsonReader in) throws IOException {
             ...
             Feedbacks instance = thisAdapter.fromJsonTree(jsonObj);
