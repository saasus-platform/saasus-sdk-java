...
public class Feedback {
  ...
  **/
   ...
   * @return the Feedback instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(feedbackTitle, feedbackDescription, comments, count, users, id, userId, createdAt, status, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Feedback>() {
           ...
           public Feedback read(JsonReader in) throws IOException {
             ...
             Feedback instance = thisAdapter.fromJsonTree(jsonObj);
