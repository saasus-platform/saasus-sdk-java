...
public class CreateApiKeyParam {
  ...
  **/
   ...
   * @return the CreateApiKeyParam instance itself
   */
  public CreateApiKeyParam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, createApiKeyParam.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, createApiKeyParam.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, envId, userId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateApiKeyParam
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApiKeyParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApiKeyParam is not found in the empty JSON string", CreateApiKeyParam.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateApiKeyParam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApiKeyParam.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateApiKeyParam>() {
           ...
           public CreateApiKeyParam read(JsonReader in) throws IOException {
             ...
             CreateApiKeyParam instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateApiKeyParam
  */
