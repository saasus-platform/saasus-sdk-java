...
public class EndpointSettings {
  ...
  **/
   ...
   * @return the EndpointSettings instance itself
   */
  public EndpointSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.path, endpointSettings.path) &&
        ...
        Objects.equals(this.additionalProperties, endpointSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(path, method, throttlings, roleNames, mappingEndpointId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EndpointSettings>() {
           ...
           public EndpointSettings read(JsonReader in) throws IOException {
             ...
             EndpointSettings instance = thisAdapter.fromJsonTree(jsonObj);
