...
public class UpdateTenantParam {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedIps, routing);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTenantParam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTenantParam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
