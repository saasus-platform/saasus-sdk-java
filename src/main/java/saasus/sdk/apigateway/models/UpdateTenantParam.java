...
public class UpdateTenantParam {
  ...
  public UpdateTenantParam allowedIps(List<String> allowedIps) {
    this.allowedIps = allowedIps;
    return this;
  }

  public UpdateTenantParam addAllowedIpsItem(String allowedIpsItem) {
  ...
  **/
   ...
   * @return the UpdateTenantParam instance itself
   */
  public UpdateTenantParam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowedIps, updateTenantParam.allowedIps) &&
        Objects.equals(this.routing, updateTenantParam.routing)&&
        Objects.equals(this.additionalProperties, updateTenantParam.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowedIps, routing, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateTenantParam
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTenantParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTenantParam is not found in the empty JSON string", UpdateTenantParam.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UpdateTenantParam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTenantParam.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateTenantParam>() {
           ...
           public UpdateTenantParam read(JsonReader in) throws IOException {
             ...
             UpdateTenantParam instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateTenantParam
  */
