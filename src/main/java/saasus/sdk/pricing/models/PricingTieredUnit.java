...
public class PricingTieredUnit {
  ...
  **/
  ...
  public PricingTieredUnit addTiersItem(PricingTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the PricingTieredUnit instance itself
   */
  public PricingTieredUnit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PricingTieredUnit pricingTieredUnit = (PricingTieredUnit) o;
    return Objects.equals(this.upperCount, pricingTieredUnit.upperCount) &&
        ...
        Objects.equals(this.meteringUnitId, pricingTieredUnit.meteringUnitId) &&
        Objects.equals(this.recurringInterval, pricingTieredUnit.recurringInterval) &&
        Objects.equals(this.used, pricingTieredUnit.used)&&
        Objects.equals(this.additionalProperties, pricingTieredUnit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(upperCount, meteringUnitName, aggregateUsage, name, displayName, description, type, currency, tiers, id, meteringUnitId, recurringInterval, used, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PricingTieredUnit
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricingTieredUnit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingTieredUnit is not found in the empty JSON string", PricingTieredUnit.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingTieredUnit.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingTieredUnit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingTieredUnit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingTieredUnit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingTieredUnit.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingTieredUnit>() {
           @Override
           public void write(JsonWriter out, PricingTieredUnit value) throws IOException {
           ...
           @Override
           public PricingTieredUnit read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PricingTieredUnit instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PricingTieredUnit given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PricingTieredUnit
  * @throws IOException if the JSON string is invalid with respect to PricingTieredUnit
  */
  public static PricingTieredUnit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingTieredUnit.class);
  }

 /**
  * Convert an instance of PricingTieredUnit to an JSON string
  *
  * @return JSON string
  */
