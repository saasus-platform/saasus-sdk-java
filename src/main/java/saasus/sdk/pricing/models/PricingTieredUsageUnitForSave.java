...
public class PricingTieredUsageUnitForSave {
  ...
  **/
   ...
   * @return the PricingTieredUsageUnitForSave instance itself
   */
  public PricingTieredUsageUnitForSave putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, pricingTieredUsageUnitForSave.name) &&
        ...
        Objects.equals(this.additionalProperties, pricingTieredUsageUnitForSave.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, description, type, currency, tiers, upperCount, meteringUnitName, aggregateUsage, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PricingTieredUsageUnitForSave>() {
           ...
           public PricingTieredUsageUnitForSave read(JsonReader in) throws IOException {
             ...
             PricingTieredUsageUnitForSave instance = thisAdapter.fromJsonTree(jsonObj);
