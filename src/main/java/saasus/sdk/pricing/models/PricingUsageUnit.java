...
public class PricingUsageUnit {
  ...
  **/
   ...
   * @return the PricingUsageUnit instance itself
   */
  public PricingUsageUnit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.upperCount, pricingUsageUnit.upperCount) &&
        ...
        Objects.equals(this.additionalProperties, pricingUsageUnit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(upperCount, unitAmount, meteringUnitName, aggregateUsage, name, displayName, description, type, currency, id, meteringUnitId, recurringInterval, used, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PricingUsageUnit>() {
           ...
           public PricingUsageUnit read(JsonReader in) throws IOException {
             ...
             PricingUsageUnit instance = thisAdapter.fromJsonTree(jsonObj);
