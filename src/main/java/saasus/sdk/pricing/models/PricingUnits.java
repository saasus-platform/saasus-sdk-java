...
public class PricingUnits {
  ...
  **/
   ...
   * @return the PricingUnits instance itself
   */
  public PricingUnits putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.units, pricingUnits.units)&&
        Objects.equals(this.additionalProperties, pricingUnits.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PricingUnits>() {
           ...
           public PricingUnits read(JsonReader in) throws IOException {
             ...
             PricingUnits instance = thisAdapter.fromJsonTree(jsonObj);
