...
public class PricingFixedUnitForSave {
  ...
  **/
   ...
   * @return the PricingFixedUnitForSave instance itself
   */
  public PricingFixedUnitForSave putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, pricingFixedUnitForSave.name) &&
        ...
        Objects.equals(this.additionalProperties, pricingFixedUnitForSave.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, description, type, currency, unitAmount, recurringInterval, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PricingFixedUnitForSave>() {
           ...
           public PricingFixedUnitForSave read(JsonReader in) throws IOException {
             ...
             PricingFixedUnitForSave instance = thisAdapter.fromJsonTree(jsonObj);
