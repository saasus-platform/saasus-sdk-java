...
public class PricingPlan {
  ...
  **/
   ...
   * @return the PricingPlan instance itself
   */
  public PricingPlan putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, pricingPlan.name) &&
        ...
        Objects.equals(this.additionalProperties, pricingPlan.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, description, used, pricingMenus, id, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PricingPlan>() {
           ...
           public PricingPlan read(JsonReader in) throws IOException {
             ...
             PricingPlan instance = thisAdapter.fromJsonTree(jsonObj);
