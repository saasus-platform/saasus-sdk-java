...
public class MeteringUnit {
  ...
  **/
   ...
   * @return the MeteringUnit instance itself
   */
  public MeteringUnit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.unitName, meteringUnit.unitName) &&
        ...
        Objects.equals(this.additionalProperties, meteringUnit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(unitName, aggregateUsage, displayName, description, id, used, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MeteringUnit>() {
           ...
           public MeteringUnit read(JsonReader in) throws IOException {
             ...
             MeteringUnit instance = thisAdapter.fromJsonTree(jsonObj);
