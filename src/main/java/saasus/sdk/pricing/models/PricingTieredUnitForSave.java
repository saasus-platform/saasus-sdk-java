...
public class PricingTieredUnitForSave {
  ...
  **/
   ...
   * @return the PricingTieredUnitForSave instance itself
   */
  public PricingTieredUnitForSave putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, pricingTieredUnitForSave.name) &&
        ...
        Objects.equals(this.additionalProperties, pricingTieredUnitForSave.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PricingTieredUnitForSave>() {
           ...
           public PricingTieredUnitForSave read(JsonReader in) throws IOException {
             ...
             PricingTieredUnitForSave instance = thisAdapter.fromJsonTree(jsonObj);
