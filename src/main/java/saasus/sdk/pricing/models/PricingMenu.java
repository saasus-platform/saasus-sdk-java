...
public class PricingMenu {
  ...
  **/
   ...
   * @return the PricingMenu instance itself
   */
  public PricingMenu putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, pricingMenu.name) &&
        ...
        Objects.equals(this.additionalProperties, pricingMenu.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, description, used, units, id, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PricingMenu>() {
           ...
           public PricingMenu read(JsonReader in) throws IOException {
             ...
             PricingMenu instance = thisAdapter.fromJsonTree(jsonObj);
