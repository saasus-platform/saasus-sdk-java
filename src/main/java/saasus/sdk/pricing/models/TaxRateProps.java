...
public class TaxRateProps {
  ...
  **/
   ...
   * @return the TaxRateProps instance itself
   */
  public TaxRateProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, taxRateProps.name) &&
        ...
        Objects.equals(this.additionalProperties, taxRateProps.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, percentage, inclusive, country, description, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TaxRateProps>() {
           ...
           public TaxRateProps read(JsonReader in) throws IOException {
             ...
             TaxRateProps instance = thisAdapter.fromJsonTree(jsonObj);
