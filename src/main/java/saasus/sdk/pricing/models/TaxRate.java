...
public class TaxRate {
  ...
  **/
   ...
   * @return the TaxRate instance itself
   */
  public TaxRate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, taxRate.name) &&
        ...
        Objects.equals(this.additionalProperties, taxRate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, percentage, inclusive, country, description, id, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TaxRate>() {
           ...
           public TaxRate read(JsonReader in) throws IOException {
             ...
             TaxRate instance = thisAdapter.fromJsonTree(jsonObj);
