...
public class TaxRates {
  ...
  **/
   ...
   * @return the TaxRates instance itself
   */
  public TaxRates putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.taxRates, taxRates.taxRates)&&
        Objects.equals(this.additionalProperties, taxRates.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taxRates, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TaxRates>() {
           ...
           public TaxRates read(JsonReader in) throws IOException {
             ...
             TaxRates instance = thisAdapter.fromJsonTree(jsonObj);
