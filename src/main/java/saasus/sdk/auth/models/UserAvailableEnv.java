...
public class UserAvailableEnv {
  ...
  **/
   ...
   * @return the UserAvailableEnv instance itself
   */
  public UserAvailableEnv putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userAvailableEnv.id) &&
        ...
        Objects.equals(this.additionalProperties, userAvailableEnv.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, displayName, roles, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserAvailableEnv>() {
           ...
           public UserAvailableEnv read(JsonReader in) throws IOException {
             ...
             UserAvailableEnv instance = thisAdapter.fromJsonTree(jsonObj);
