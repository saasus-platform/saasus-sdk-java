...
public class UpdateSignInSettingsParam {
  ...
  **/
   ...
   * @return the UpdateSignInSettingsParam instance itself
   */
  public UpdateSignInSettingsParam putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateSignInSettingsParam>() {
           ...
           public UpdateSignInSettingsParam read(JsonReader in) throws IOException {
             ...
             UpdateSignInSettingsParam instance = thisAdapter.fromJsonTree(jsonObj);
