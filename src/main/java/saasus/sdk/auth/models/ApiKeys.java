...
public class ApiKeys {
  ...
  **/
   ...
   * @return the ApiKeys instance itself
   */
  public ApiKeys putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKeys, apiKeys.apiKeys)&&
        Objects.equals(this.additionalProperties, apiKeys.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApiKeys>() {
           ...
           public ApiKeys read(JsonReader in) throws IOException {
             ...
             ApiKeys instance = thisAdapter.fromJsonTree(jsonObj);
