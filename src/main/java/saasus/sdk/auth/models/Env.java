...
public class Env {
  ...
  **/
   ...
   * @return the Env instance itself
   */
  public Env putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, env.id) &&
        ...
        Objects.equals(this.additionalProperties, env.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Env>() {
           ...
           public Env read(JsonReader in) throws IOException {
             ...
             Env instance = thisAdapter.fromJsonTree(jsonObj);
