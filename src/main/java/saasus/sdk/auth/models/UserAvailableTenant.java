...
public class UserAvailableTenant {
  ...
  **/
   ...
   * @return the UserAvailableTenant instance itself
   */
  public UserAvailableTenant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userAvailableTenant.id) &&
        ...
        Objects.equals(this.additionalProperties, userAvailableTenant.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, completedSignUp, envs, userAttribute, backOfficeStaffEmail, planId, isPaid, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserAvailableTenant>() {
           ...
           public UserAvailableTenant read(JsonReader in) throws IOException {
             ...
             UserAvailableTenant instance = thisAdapter.fromJsonTree(jsonObj);
