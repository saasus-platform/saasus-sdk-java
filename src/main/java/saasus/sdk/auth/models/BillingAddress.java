...
public class BillingAddress {
  ...
  **/
   ...
   * @return the BillingAddress instance itself
   */
  public BillingAddress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.street, billingAddress.street) &&
        ...
        Objects.equals(this.additionalProperties, billingAddress.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(street, city, state, country, additionalAddressInfo, postalCode, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BillingAddress>() {
           ...
           public BillingAddress read(JsonReader in) throws IOException {
             ...
             BillingAddress instance = thisAdapter.fromJsonTree(jsonObj);
