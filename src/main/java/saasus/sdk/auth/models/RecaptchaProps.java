...
public class RecaptchaProps {
  ...
  **/
   ...
   * @return the RecaptchaProps instance itself
   */
  public RecaptchaProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.siteKey, recaptchaProps.siteKey) &&
        ...
        Objects.equals(this.additionalProperties, recaptchaProps.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(siteKey, secretKey, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RecaptchaProps>() {
           ...
           public RecaptchaProps read(JsonReader in) throws IOException {
             ...
             RecaptchaProps instance = thisAdapter.fromJsonTree(jsonObj);
