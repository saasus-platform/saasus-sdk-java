...
public class TenantProps {
  ...
  **/
   ...
   * @return the TenantProps instance itself
   */
  public TenantProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, tenantProps.name) &&
        ...
        Objects.equals(this.additionalProperties, tenantProps.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, attributes, backOfficeStaffEmail, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TenantProps>() {
           ...
           public TenantProps read(JsonReader in) throws IOException {
             ...
             TenantProps instance = thisAdapter.fromJsonTree(jsonObj);
