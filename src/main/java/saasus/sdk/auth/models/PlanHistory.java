...
public class PlanHistory {
  ...
  **/
   ...
   * @return the PlanHistory instance itself
   */
  public PlanHistory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.planId, planHistory.planId) &&
        ...
        Objects.equals(this.additionalProperties, planHistory.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(planId, planAppliedAt, taxRateId, prorationBehavior, deleteUsage, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PlanHistory>() {
           ...
           public PlanHistory read(JsonReader in) throws IOException {
             ...
             PlanHistory instance = thisAdapter.fromJsonTree(jsonObj);
