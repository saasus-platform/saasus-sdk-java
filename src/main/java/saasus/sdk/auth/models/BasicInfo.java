...
public class BasicInfo {
  ...
  **/
   ...
   * @return the BasicInfo instance itself
   */
  public BasicInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domainName, basicInfo.domainName) &&
        ...
        Objects.equals(this.additionalProperties, basicInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainName, isDnsValidated, certificateDnsRecord, cloudFrontDnsRecord, dkimDnsRecords, defaultDomainName, fromEmailAddress, replyEmailAddress, isSesSandboxGranted, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasicInfo>() {
           ...
           public BasicInfo read(JsonReader in) throws IOException {
             ...
             BasicInfo instance = thisAdapter.fromJsonTree(jsonObj);
