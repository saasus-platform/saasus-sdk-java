...
public class TenantDetail {
  ...
  **/
   ...
   * @return the TenantDetail instance itself
   */
  public TenantDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tenantDetail.id) &&
        ...
        Objects.equals(this.additionalProperties, tenantDetail.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, planId, billingInfo, name, attributes, backOfficeStaffEmail, nextPlanId, usingNextPlanFrom, nextPlanTaxRateId, prorationBehavior, deleteUsage, planHistories, currentPlanPeriodStart, currentPlanPeriodEnd, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TenantDetail>() {
           ...
           public TenantDetail read(JsonReader in) throws IOException {
             ...
             TenantDetail instance = thisAdapter.fromJsonTree(jsonObj);
