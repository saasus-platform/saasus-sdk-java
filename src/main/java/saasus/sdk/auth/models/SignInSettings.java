...
public class SignInSettings {
  ...
  **/
   ...
   * @return the SignInSettings instance itself
   */
  public SignInSettings putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SignInSettings>() {
           ...
           public SignInSettings read(JsonReader in) throws IOException {
             ...
             SignInSettings instance = thisAdapter.fromJsonTree(jsonObj);
