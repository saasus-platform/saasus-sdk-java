...
public class UpdateSoftwareTokenParam {
  ...
  **/
   ...
   * @return the UpdateSoftwareTokenParam instance itself
   */
  public UpdateSoftwareTokenParam putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, verificationCode, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateSoftwareTokenParam>() {
           ...
           public UpdateSoftwareTokenParam read(JsonReader in) throws IOException {
             ...
             UpdateSoftwareTokenParam instance = thisAdapter.fromJsonTree(jsonObj);
