...
public class CustomizePageSettings {
  ...
  **/
   ...
   * @return the CustomizePageSettings instance itself
   */
  public CustomizePageSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, customizePageSettings.title) &&
        ...
        Objects.equals(this.additionalProperties, customizePageSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, termsOfServiceUrl, privacyPolicyUrl, googleTagManagerContainerId, icon, favicon, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomizePageSettings>() {
           ...
           public CustomizePageSettings read(JsonReader in) throws IOException {
             ...
             CustomizePageSettings instance = thisAdapter.fromJsonTree(jsonObj);
