...
public class DeviceConfiguration {
  ...
  **/
   ...
   * @return the DeviceConfiguration instance itself
   */
  public DeviceConfiguration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deviceRemembering, deviceConfiguration.deviceRemembering)&&
        Objects.equals(this.additionalProperties, deviceConfiguration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceRemembering, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeviceConfiguration>() {
           ...
           public DeviceConfiguration read(JsonReader in) throws IOException {
             ...
             DeviceConfiguration instance = thisAdapter.fromJsonTree(jsonObj);
