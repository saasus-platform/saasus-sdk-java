...
public class SaasUserApi {
    ...
    /**
     * Build call for updateSaasUserAttributes
     * @param userId User ID (required)
     * @param updateSaasUserAttributesParam  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateSaasUserAttributesCall(String userId, UpdateSaasUserAttributesParam updateSaasUserAttributesParam, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = updateSaasUserAttributesParam;

        // create path and map variables
        String localVarPath = "/users/{user_id}/attributes"
            .replace("{" + "user_id" + "}", localVarApiClient.escapeString(userId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSaasUserAttributesValidateBeforeCall(String userId, UpdateSaasUserAttributesParam updateSaasUserAttributesParam, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling updateSaasUserAttributes(Async)");
        }

        return updateSaasUserAttributesCall(userId, updateSaasUserAttributesParam, _callback);
     ...
     */
    public void updateSaasUserAttributes(String userId, UpdateSaasUserAttributesParam updateSaasUserAttributesParam) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateSaasUserAttributesWithHttpInfo(String userId, UpdateSaasUserAttributesParam updateSaasUserAttributesParam) throws ApiException {
        okhttp3.Call localVarCall = updateSaasUserAttributesValidateBeforeCall(userId, updateSaasUserAttributesParam, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Update SaaS User Attributes (asynchronously)
     * Update the additional attributes of the SaaS user. 
     * @param userId User ID (required)
     * @param updateSaasUserAttributesParam  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateSaasUserAttributesAsync(String userId, UpdateSaasUserAttributesParam updateSaasUserAttributesParam, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSaasUserAttributesValidateBeforeCall(userId, updateSaasUserAttributesParam, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
